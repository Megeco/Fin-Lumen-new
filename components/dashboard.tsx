  ...
  return <main>
    ...
    <div className="shell" id="top">
      ...
      <section className="workspace">
        ...
        <div className="table-foot"><span>Showing {visible.length} of {watchlist.length} readings</span><span>Swiss Ephemeris · Lahiri · Personal build 37.9.14.3</span><span>Scores describe astrological structure and intensity; they are not financial forecasts.</span></div>
